...
;;  -------------------------------------------------------------------------------
(defun encuentra-muro   (cosa bis / angulo pt1 pt2 seleccion num-sel punto indice lista-dist nombre entidad distancia intersec pgr tolerancia)
  ...
  ;; Sólo partiré objetos hechos con líneas
